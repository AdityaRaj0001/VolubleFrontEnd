...
export default function App() {
  ...
  return (
    <Navbar isBordered isBlurred={false} isMenuOpen={isMenuOpen} onMenuOpenChange={setIsMenuOpen} className="absolute bg-transparent m-auto text-white flex justify-between lg:justify-center w-full items-center  " >
